...
4. Enter each quote's deposits, interest (or either loan’s monthly repayment), insurance, scheduled running costs and included services. Add an annual or year-specific repair budget when needed, optionally stopping it after a separate number of months. Configure VAT and optional manual income-tax effects where applicable.
